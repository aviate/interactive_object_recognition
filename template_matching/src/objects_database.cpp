...
void ObjectsDatabase::createDatabase(TemplateLibrary &templateLibrary)
{
	...
	for (std::vector<Template>::iterator it = library_templates.begin();
		it != library_templates.end();
		it++)
	{
...
void ObjectsDatabase::createTrainingDatabase(TemplateLibrary &templateLibrary)
{
	...
	for (std::vector<Template>::iterator it = training_templates.begin();
...
std::vector<ObjectData> ObjectsDatabase::databaseObjects()
{
	return databaseObjects_;
}