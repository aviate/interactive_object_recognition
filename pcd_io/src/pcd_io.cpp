...
void PcdIO::getDirectoryListWithExtension(
...
void PcdIO::getFileListWithExtension(
	const std::string &input_dir,
...
void PcdIO::loadImagesFromDir(
	std::string directory,
	std::vector<cv::Mat> &images)
{
	std::set<std::string> file_list;
	//XXX this was .png before
	getFileListWithExtension(directory, ".jpg", file_list);
	for (std::set<std::string>::iterator itr = file_list.begin();
		itr != file_list.end();
		itr++)
	{
...
void PcdIO::loadPointcloudsFromDir(
	std::string directory,
